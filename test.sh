...
#Create task definition for ECS -register
...
#aws ecs update-service --cluster kevin_onboardingtasks_flask \
#--service kevin_onboardingtasks_flask \
#--task-definition kevin_onboardingtasks_flask:7
